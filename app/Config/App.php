...
class App extends BaseConfig
{
	...
	public string $baseURL = 'https://dancacarajas.com.br/bxteste/public/';
...
private function set_base_url()
{
    if (isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] !== 'localhost') {
         $this->baseURL = 'https://dancacarajas.com.br/bxteste/public/';
        //$this->baseURL = 'https://dancacarajas.com.br/inscricoes/public/';
    } else {
         $this->baseURL = 'http://localhost:8080/bxteste/public/';
	...
	public $sessionSavePath = 'ci_sessions'; // Nome da tabela de sess�es
