<?php 
	...
	$evcfg_config_infos = [
		...
		'rs_valores_por_coreografias' => (isset($rs_valores_por_coreografias) ? $rs_valores_por_coreografias : []),
		'rs_valores_por_participantes' => (isset($rs_valores_por_participantes) ? $rs_valores_por_participantes : []),
	];

	$rs_event_valores = (isset($rs_event_valores) ? $rs_event_valores : []);
...
<?php $this->section('scripts'); ?>
	...
	<!-- JavaScript antigo removido - agora usa Vue.js -->
